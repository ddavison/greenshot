...
namespace GreenshotOfficePlugin {
	...
	public class OfficeConfiguration : IniSection {
		...
		[IniProperty("OutlookAllowExportInMeetings", Expert = true, Description = "Allow export in meeting items", DefaultValue = "False")]
		...
		[IniProperty("OutlookIncludeDefaultSignature", Description = "For Outlook: include the default signature.", DefaultValue = "True")]
		public bool OutlookIncludeDefaultSignature {
			get;
			set;
		}
	}
