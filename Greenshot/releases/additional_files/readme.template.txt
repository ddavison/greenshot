...
2.0.0 build $WCREV$ Unstable

Features:
* Redesigned the settings windows so it can contain a lot more settings.
* Added the possilibity to configure the list of destinations in the destination picker.


1.1.6 build XXXX Bugfix Release
